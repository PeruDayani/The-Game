...
public class TETile implements java.io.Serializable {
     ...
     * @param description
     * The description of the tile, shown in the GUI on hovering over the tile.
     * @param filepath
     * Full path to image to be used for this tile. Must be correct size (16x16)
     */
    ...
    /**
     * Constructor without filepath. In this case,
     * filepath will be null, so when drawing, we
     * will not even try to draw an image, and
     * will instead use the provided character and colors.
     *
     * @param character       The character displayed on the screen.
     * @param textColor       The color of the character itself.
     * @param backgroundColor The color drawn behind the character.
